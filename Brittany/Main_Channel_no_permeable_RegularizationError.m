...
Ly_near=0.09; ymax_near=ymin_near+Ly_near;
...
figure;
   ...
   loglog(epsvals, eumaxnorm_near(i,:),'o-', 'LineWidth', 2.5, 'MarkerSize', ...
       10)
    hold on
...
title('Non-permeable channel: Error on grid $[0.001, 0.091]\times [2,3]$',...
