...
%Beta giceves the permeability coefficient for all sour points., Nx1
    %beta(i) should be 0 if it is not a permeable section
%normal is Nx2, giving unit normals for source points
...
[H1, H2, S1, S2, Q] = reg_fncs_withdoubletQ(ep, R, blob_num); %MxN
