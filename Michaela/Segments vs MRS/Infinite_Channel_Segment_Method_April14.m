...
C = 0.13; % Coefficient for beta = C*Da*ep, use 0.13 for phi, and 0.039 for psi
...
%[gseg] = sd_segments_velocitytogforce_beta_linear([y1,y2],[u1b,u2b],normals,mu,segData,blob_num);
g1seg = gseg(:,1);
g2seg = gseg(:,2);
...
%[useg_perm] = sd_segments_gforcetovelocity_beta_linear([y1b,y2b],[y1,y2],gseg,normals,mu,segData,blob_num);
