...
%Add another set of points on which to compute velocity 
Nz = 
z1 = 
z2 = 
...
%forces on cylinder boundary - CHANGE THIS TO NORMAL FORCES  
...
%computing velocity on z points 
uz = RegStokeslets2D_forcetovelocity([y1,y2],[f1,f2],[z1,z2],ep,mu,blob_num);
uz1 = uz(:,1);
uz2 = uz(:,2); 

%% Computing error - FIX THIS 
